...
(function() {
    ...
    function setupMedia() {
        ...
        // Video
        if (config.VideoPath) {
            if (config.VideoPath.endsWith('.webm')) {
    ...
    function setupDiscord() {
        ...
        if (config.DiscordLink) {
            elements.discordLink.href = 'https://' + config.DiscordLink;
        } else {
    ...
    function setupUIVisibility() {
        ...
        if (!uiConfig.ShowRules) {
            elements.rulesContainer.style.display = 'none';
        }

        if (!uiConfig.ShowTips) {
            elements.tipsSection.style.display = 'none';
        }

        if (!uiConfig.ShowDiscord) {
            elements.discordSection.style.display = 'none';
        }
    }
